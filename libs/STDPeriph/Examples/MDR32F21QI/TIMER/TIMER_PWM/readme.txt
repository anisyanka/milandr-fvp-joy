...
A demonstration of the timer operation in PWM mode. PWM pulses are generated at the PA5-PA0 pins with duty cycle:
- CH1 (PA0) = 12.5% and CH1N (PA1) = 87.5%;
- CH2 (PA2) = 25% and CH2N (PA3) = 75%;
- CH3 (PA4) = 50% and CH3N (PA5) = 50%.
