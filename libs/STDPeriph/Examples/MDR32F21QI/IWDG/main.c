...
/** @addtogroup IWDG_234 IWDG example for K1986VK234 evaluation board
 *  @{
 */
...
/**
 * @brief  Blink with LED2
 * @param  num - blinks number
 * @param  del - delay
 * @retval None
 */
void BlinkLED2(uint32_t num, uint32_t del)
{
    uint32_t cnt;
