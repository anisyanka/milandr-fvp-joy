...
/** @addtogroup EEPROM_234 EEPROM example for K1986VK234 evaluation board
 *  @{
 */
...
#define LED_MASK              (PORT_PIN_4 | PORT_PIN_5 | PORT_PIN_6 | PORT_PIN_7)

/* Private macro -------------------------------------------------------------*/
#define LED_TST_NUM(num) (((num) << 4) & LED_MASK)
