...
The example demonstrates the software calculation of the CRC and the comparison of the obtained with the CRC calculated via the hardware module.
The Pin PC4 switches to "HIGH" if the data is correct.
