...
When using the HSE + PLL generator, the PC14 pin is switched,
when using the LSI generator, the PC15 pin is switched,
when using the LSE generator, the PC14 and PC15 pins are switched.
