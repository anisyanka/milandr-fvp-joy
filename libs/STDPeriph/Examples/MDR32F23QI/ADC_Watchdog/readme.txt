  /**
  @addtogroup ADC_Watchdog_214 ADC_Watchdog example for K1986VK214 evaluation board
  @latexonly
  @verbatim
...
an ADC channel 1 in the given range (0x0800-0x0900).
The ADC1 is configured to convert continuously ADC channel 1.

The analog watchdog is configured and enabled to guard a single regular channel.
Each time the channel 1 converted value exceed programmed analog watchdog high
...
that the converted value of regular ADC channel 1 is outside the range limited by high
and low analog watchdog thresholds.
The LED2 will bright as long as the converted value of regular ADC channel 1 is above the upper limit.
Regular ADC channel 1 connected to the trim resistor.
