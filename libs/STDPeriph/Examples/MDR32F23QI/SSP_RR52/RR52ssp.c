...
#define nCS_ACTIVE     PORT_ResetBits(MDR_PORTC, PORT_PIN_10)
#define nCS_NOT_ACTIVE PORT_SetBits(MDR_PORTC, PORT_PIN_10)

/** @addtogroup SSP_RR52_214_Exported_Functions SSP RR52 Exported Function
 * @{
 */
...
void RR52SSP_PortConfig(void)
{
    ...
    PORT_InitStructure.PORT_Pin   = (PORT_PIN_11 | PORT_PIN_12 | PORT_PIN_13);
