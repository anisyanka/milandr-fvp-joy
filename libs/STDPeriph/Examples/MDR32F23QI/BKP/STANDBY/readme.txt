/**
  @addtogroup BKP_STANDBY_214 BKP STANDBY example for K1986VK214 evaluation board
  @latexonly
  @verbatim
...
That action includes the following steps:
    - Configure PORTC line 14 as output LED1;
    - Turn on/off LED1 when the regulator is turned on;
    - Enter STANDBY mode;
    - Press the button WakeUp to enable the regulator to 1.8V DUcc -> MCU boot.
