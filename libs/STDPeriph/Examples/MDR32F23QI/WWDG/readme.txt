  /**
  @addtogroup WWDG_214 WWDG example for K1986VK214 evaluation board
  @latexonly
  @verbatim
...
A demonstration of the operation of the WWDG module. PC14 is used to indicate when a counter value is updated.
